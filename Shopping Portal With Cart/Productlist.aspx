...
<%@ Register src="_ProductList.ascx" tagname="_ProductList" tagprefix="uc3" %>
<%@ Register src="_SmallCart.ascx" tagname="_SmallCart" tagprefix="uc4" %>

<%@ Register src="_loginstatus.ascx" tagname="_loginstatus" tagprefix="uc5" %>
...
{
clearInterval(inth);
ints=setInterval("show()",10);
}
function hidemenu()
{
clearInterval(ints);
inth=setInterval("hide()",10);
}
function show()
{
if (i<-8)
	{
	i=i+speed;
	document.getElementById('slideMenu').style.left=i;
	}
}
function hide()
{
...
function ontop()
{
document.getElementById('topmenu').style.top=document.body.scrollTop;
timer=setTimeout("ontop()",1);
}
function stoptop()
{
clearTimeout(timer);
...
<body onload="ontop()" onunload="stoptop()">
<div id="main">  
    <div class="container">  
	      ...
	      <form id="form1" runat="server">
            ...
            <div id="header">   
                ...
                <ul id="menu">  
				 <li><a href=""></a></li> 
                    <uc5:_loginstatus ID="_loginstatus1" runat="server" />
              </ul>
...
<div class="block_feature">
    ...
    <div>
     <div>
        <span id="topmenu" style="position:absolute;">
        <table id="slideMenu" class="menu"   border="0" width="190" onmouseover="showmenu()" onmouseout="hidemenu()" align="center" class="style2" >
            <tr>
                <td class="style9">
                    <uc2:_Categoriesmenu ID="_Categoriesmenu1" runat="server" />
                </td>
                </tr>
                </table>
                </span>
                ...
                <td class="style6">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    &nbsp;<uc3:_ProductList ID="_ProductList1" runat="server" /></td>
                <td class="style7">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
                    <uc4:_SmallCart ID="_SmallCart1" runat="server" />
                </td>
            </tr>
        </table>
    </div>
