...
<%@ Register src="_VerifyDetails.ascx" tagname="_VerifyDetails" tagprefix="uc2" %>
...
<div id="main">  
    <div class="container">  
      ...
      <form id="form1" runat="server">    
            ...
            <div id="header">   
                ...
                <ul id="menu">  
                 <li> <a href=""> <img src="images/btn_faq.jpg" width="155" height="47"/></a></li>
				 <li><a href=""></a>
                    ...
                    <uc3:_loginstatus ID="_loginstatus1" runat="server" />
              </ul>
    ...
    <div class="block_feature">
	 ...
	 <span class="block_inside">
                    <img src="images/home_11_r1.jpg" width="315" height="190" /></span></div>  
   ...
   <div> 
    ...
    <table class="style1">
        ...
        <tr>
            <td>
                <uc2:_VerifyDetails ID="_VerifyDetails1" runat="server" align="center"/>
            </td>
        </tr>
    </table>
